...
## not yet implemented as quadtree method appears to work well
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##
...
get_sample_counts <- function(ss = 1,
  ...
  ## If some of your pts don't fit into the poly shapes
  ## they get randomly assigned to folds at the end - throw a warning
...
## adapted version. quadtree by sum of value at each point.
