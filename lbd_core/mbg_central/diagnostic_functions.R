...
#'
#' @description Pulls legend out of a ggplot object for use later
#'
...
plot_gam_models <- function(child_model_list, regions, o_dir) {
  ...
  for (reg in regions) {
    ...
    # Set up directory
    dirname <- paste0(<<<< FILEPATH REDACTED >>>>)
