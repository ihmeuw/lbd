...
#                           run_date = run_date
  ...
  if(save_qt){
    ...
    qt_shape_dir <- paste0(<<<< FILEPATH REDACTED >>>>)
    ...
    write.shapefile(polys_shapefile, paste0(<<<< FILEPATH REDACTED >>>>), arcgis=TRUE)
  }
...
## folds <- ad2_folds(admin_raster=<<<< FILEPATH REDACTED >>>>,
##                   shape_ident="gaul_code",
...
make_folds <- function(data,
                       ...
                       temp_strat = NULL,
                       spte_strat = NULL,
                       save.file = paste0(<<<< FILEPATH REDACTED >>>>), ## place to save the final object from the function
                       ...,
