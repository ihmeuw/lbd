...
load_admin_raster  <- function(admin_level, simple_raster, disag_fact=NULL,
  ...
  shapes[[paste0('ADM', admin_level,'_CODE')]][shapes[[paste0('ADM', admin_level,'_CODE')]]==91   ]=267 #Gaza Strip -> Palestine
  shapes[[paste0('ADM', admin_level,'_CODE')]][shapes[[paste0('ADM', admin_level,'_CODE')]]==33364   ]=147295 #Hong Kong -> China
  # crop
...
#   #
#   sadm <- shapefile(sprintf('%s<<< FILEPATH REDACTED >>>
...
#   sadm0 <- shapefile(sprintf('%s<<< FILEPATH REDACTED >>>
...
make_population_weights  <- function(admin_level,
  ...
  if(admin_level==0) adm[adm==1013965]=227
  if(admin_level==0) adm[adm==91267]=267
