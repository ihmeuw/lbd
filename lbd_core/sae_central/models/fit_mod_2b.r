...
##              log(m_{j,t}) = B0 + B1*X_{j,t} + u1_{t} + u2_{j} + u3_{j}*t + u5_{j,t}
...
openmp(16)
TMB::compile("models/mod_2b.cpp")
dyn.load(dynlib("models/mod_2b"))
config(tape.parallel=0, DLL="mod_2b")

# make objective function
cat("\n\n***** Make objective function\n"); flush.console()
obj <- MakeADFun(tmb_data, tmb_par, random=c("B", paste0("re", c(1:3,5))), DLL="mod_2b")
