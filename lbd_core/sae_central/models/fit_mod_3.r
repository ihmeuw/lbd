...
##              log(m_{j,a,t}) = B0 + B1*X_{j,t} + u1_{a,t} + u2_{j}
...
openmp(16)
TMB::compile("models/mod_3.cpp")
dyn.load(dynlib("models/mod_3"))
config(tape.parallel=0, DLL="mod_3")

# make objective function
cat("\n\n***** Make objective function\n"); flush.console()
obj <- MakeADFun(tmb_data, tmb_par, random=c("B", paste0("re", 1:2)), DLL="mod_3")
