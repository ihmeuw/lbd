...
openmp(16)
TMB::compile("models/mod_4.cpp")
dyn.load(dynlib("models/mod_4"))
config(tape.parallel=0, DLL="mod_4")

# make objective function
cat("\n\n***** Make objective function\n"); flush.console()
obj <- MakeADFun(tmb_data, tmb_par, random=c("B", "re1", "re2", "re3"), DLL="mod_4")
