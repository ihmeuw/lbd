...
draws <- rbindlist(lapply(sexes, function(sex) {
  load(paste0(temp_dir, "/draws_", level, "_", year, "_", sex, ".rdata"))
  draws
}))
...
save(draws, file=paste0(temp_dir, "/draws_", level, "_", year, "_3.rdata"))
save(est, file=paste0(temp_dir, "/est_", level, "_", year, "_3.rdata"))
