...
# load draws
load(paste0(temp_dir, "/draws_", area_var, "_", year, "_", sex, ".rdata"))
...
save(draws, file=paste0(temp_dir, "/draws_", level, "_", year, "_", sex, ".rdata"))
save(est, file=paste0(temp_dir, "/est_", level, "_", year, "_", sex, ".rdata"))
