#####################################################################################################################################
### Script objective: Parent script to run MBG models for generating spatio-temporal estimates of Lymphatic filariasis (LF) prevalence
...
#
### Modeling rationale:
#   The LF modeling process involves use of point and polygon data. Polygon data are converted to point data through polygon resampling.
...
config_file <- <<<< FILEPATH REDACTED >>>>
lbd_core_branch <- <<<< FILEPATH REDACTED >>>>

indicator_group <- <<<< FILEPATH REDACTED >>>>
indicator <- <<<< FILEPATH REDACTED >>>>
parent_script <- <<<< FILEPATH REDACTED >>>>
