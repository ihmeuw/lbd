...
csv_master[country == 'NGA', region := 'NGA']
csv_master[country == 'PAK', region := 'PAK']
csv_master[country == 'KEN', region := 'KEN']
csv_master[country == 'COD', region := 'COD']
csv_master[country == 'ZWE', region := 'ZWE']
csv_master[region == 'dia_s_america', region := 'dia_s_america-bra']
...
# plot results
source('<<<< FILEPATH REDACTED >>>>/ort/custom_functions/plot_pv_results.R')
