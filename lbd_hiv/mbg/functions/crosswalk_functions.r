...
#'
#' PDF of linear model in log space fitting microdata hiv prevalence in seperate age ranges ('"<<<< FILEPATH REDACTED >>>>")
#' PDF of new to old hiv prevalences for the crosswalked report data ("<<<< FILEPATH REDACTED >>>>")
...
crosswalk_reports <- function(crosswalk_data,
  ...
  pdf(paste0("<<<< FILEPATH REDACTED >>>>", filepath_indicator,
