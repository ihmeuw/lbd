...
## Indicator:   multiple sexual partners in the last year among men, ages 15-49
####################################################################################################
...
indicator <- "multiple_partners_year_MN"
topic <- "rsp"
...
data <- subset_geomatched_multiple_partner_year_mn(data)
...
coverage_maps <- graph_data_coverage_values(df = coverage,
                                            ...
                                            title = 'Multiple sexual partners (men)',
