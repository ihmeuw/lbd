...
config <- set_up_config(repo            = indic_repo,
                        ...
                        indicator       = "",
                        indicator_group = "",
                        config_file     = paste0(indic_repo, 'mbg/covariates/2_modeling/config_', prior, '.csv'),
...
qsub <- paste('qsub -e', paste0(outputdir, 'errors'), '-o', paste0(outputdir, 'output'),
              ...
              paste0('/lbd_hiv/mbg/functions/predictive_validity.r'),
...
source('/lbd_hiv/publications/male_circumcision/accomodating_counts_functions.R')
...
maps_path <- paste0("<<<< FILEPATH REDACTED >>>>")
...
source(paste0(indic_repo, "mbg/hiv_adult_prev/3_post_estimation/data_and_estimates_maps.r"))
