...
geomatch_time_plots <- function(geomatch_data,
                                old_data,
                                save_plot = paste0("<<<< FILEPATH REDACTED >>>>")) {
  # Color palette
  ...
  message(paste("Saving plots of all countries to", paste0("<<<< FILEPATH REDACTED >>>>")))
  pdf(paste0("<<<< FILEPATH REDACTED >>>>"), height = 11, width = 18)
  ...
  message(paste("Saving plots of new countries to", paste0("<<<< FILEPATH REDACTED >>>>")))
  pdf(paste0("<<<< FILEPATH REDACTED >>>>"), height = 11, width = 18)
