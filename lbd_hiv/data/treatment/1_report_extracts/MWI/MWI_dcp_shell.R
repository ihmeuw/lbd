...
#!!!!!!!!!!!!!PLEASE READ!!!!!!!!!!!! in the standardize_file change 3 instances of hiv_treat_count to adult_alive for MWI, which is the adjusted number that should be used
...
launch_dcps(username, final_dt, test, iso3, plot_type = "art_rate") ### Change the legend rate to 1.0, save height = 20
