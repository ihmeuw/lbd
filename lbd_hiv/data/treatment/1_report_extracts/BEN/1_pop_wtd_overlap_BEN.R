...
package_list <- readLines(paste0(core_repo, "share_scripts/common_inputs/package_list.csv"))
...
## Load shps ----------------------------------------------------------------------------
# Currently using 2019 Aug 01 lbd_standard shp
...
raster_list    <- build_simple_raster_pop(subset_shape, link_table = NULL, pop_release = "2017_04_27")
